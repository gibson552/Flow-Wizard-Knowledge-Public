...
- *Step 1:* Select Excel from the import screen, and then click *Next* in the bottom right.

.. image:: ./images/excel/step_1.png
   :width: 600px
   :alt: After

- *Step 2:* Select *Choose File*, then choose your file from the File Explore Pop up. Hit *Next* when complete.

.. image:: ./images/excel/step_2.png
   :width: 600px
   :alt: After
